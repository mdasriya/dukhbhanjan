import {
  ...
  AlertDialogContent,
  AlertDialogOverlay,
  AlertDialogCloseButton, Grid, GridItem, Heading, Image, SkeletonCircle, SkeletonText, Text, useDisclosure, Badge, useToast
...
const Oderse = () => {
  ...
  const handleCancelOrder = (UserId) => {
    ...
    axios.patch(`https://outrageous-shoulder-pads-fly.cyclic.app/order/cancel/${sendId}`, { UserId: UserId },)
      .then((res) => {
        toast({
              ...
              <Box key={index}>
                  ...
                  >
                      ...
                      <AlertDialogOverlay>
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <Button colorScheme='red' onClick={() => handleCancelOrder(item.UserId)} ml={3}>
                              Order Cancel
                            </Button>
                          </AlertDialogFooter>
                        </AlertDialogContent>
                    ...
                    <Box display="flex">
                      ...
                      <Text onClick={()=>alert(item._id)}> {item._id}</Text>
                    </Box>
                    <Box display="flex">
                      <Text as="b">Name : </Text>
                    ...
                    <Box display={"flex"} justifyContent={"space-between"} mt={4}>
                      <Button onClick={()=>handleOpenConfirm(item._id)} colorScheme='red' isDisabled={item.cancel === 'canceled'} >Cancel order</Button>
