...
const Cart = () => {
  ...
  setDeleteloading(true)
    try {
      const response = await axios.delete(`https://gentle-foal-waistcoat.cyclic.app/cart/delete/${id}`, {
        headers: {
  ...
  const handlePayment = async () => {
    try {
      const { data } = await axios.post("https://gentle-foal-waistcoat.cyclic.app/api/payment/orders", { amount: totalPrice }, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const initPayment = (data) => {
    const options = {
      ...
      handler: async (response) => {
        try {
          await axios.post("https://gentle-foal-waistcoat.cyclic.app/api/payment/verify",response,{
            headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${localStorage.getItem('token')}`,
            }
  ...
  const handledeleteCartData = async (data) => {
    return axios
      .post('https://gentle-foal-waistcoat.cyclic.app/cart/order/delete', data, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleForm = (e) => {
    ...
    if (address.address1.length == 0 && address.address2.length == 0 && address.city.length == 0 && address.country.length == 0 && address.phone.length == 0 && address.postalCode.length == 0) {
      ...
      axios.post("https://gentle-foal-waistcoat.cyclic.app/address/create", address, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleMyOrderData = async (datatoAdd) => {
    ...
    try {
      const response = await axios.post("https://gentle-foal-waistcoat.cyclic.app/order/create", datatoAdd, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const conditionallyPaymentForm = async () => {
    ...
    try {
      const response = await axios.post("https://gentle-foal-waistcoat.cyclic.app/address/create", address, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
