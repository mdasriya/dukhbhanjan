...
import {
  Box, Modal, Avatar, Heading, Text, VStack, Center, Flex, SkeletonCircle, Skeleton,
...
const Profile = () => {
  ...
  return (
    <>
      {isLoading ? (
        <Box padding='6' width="100%"  maxW="800px" mx="auto" mt={10} boxShadow='lg' bg='white'>
          {/* Skeleton loading UI */}
        </Box>
      ) : (
        <Box width="100%"  mt={10} p={{base:'5',md:'10'}} display={{ base: 'block', md: 'flex' }}>
          <Box
